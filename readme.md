...
- [Velox](https://github.com/akhilsb/Velox-MPC) - Post-Quantum asynchronous MPC implemented in Rust. Offers Fairness against $t<\frac{n}{3}$ malicious parties. Scales to $n=100$ parties in real-world networks. Outperforms predecessor HoneyBadgerMPC by $40\times$. | eprint: [2025/1630](https://eprint.iacr.org/2025/1630).
