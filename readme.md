...
- [Velox](https://github.com/akhilsb/Velox-MPC) - Post-Quantum asynchronous MPC implemented in Rust. Offers Fairness against $t<\frac{n}{3}$ malicious parties. Scales to hundreds of parties in real-world networks. Outperforms predecessor HoneyBadgerMPC by over two orders of magnitude.
